...
public class Choose {
	...
	/*public static Graph chooseGraphTest(int test) {
		switch(test) {
			case 1:
	...
	public static void chooseAlg(int alg, String graphType, String sample, Graph graph, int rep, List<String> csvList) {
		switch(alg) {
			case 1:
				GraphTimes.timeBFS(graphType, sample, graph, rep, csvList);
				break;
			case 2:
				GraphTimes.timeDFS(graphType, sample, graph, rep, csvList);
				break;
			case 3:
