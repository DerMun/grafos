...
public class GraphTimes {
	public static void timeBFS(String graphType, String sampleChosen, Graph graph, int repetitions, List<String> csvList) {
        ...
        System.out.printf("\n Grafo com %s de Adjacências:",graphType);
	...
	public static void timeDFS(String graphType, String sampleChosen, Graph graph, int repetitions, List<String> csvList) {
		final double CONVERTNS4MS = 1_000_000.0;
        double[] times = new double[repetitions];
        double sum = 0, start, end, duration;
	...
	public static void timeOT(String graphType, String sampleChosen, Graph graph, int repetitions, List<String> csvList) {
		final double CONVERTNS4MS = 1_000_000.0;
        double[] times = new double[repetitions];
        double sum = 0, start, end, duration;
	...
	public static void timeBF(String graphType, String sampleChosen, Graph graph, int repetitions, List<String> csvList) {
		final double CONVERTNS4MS = 1_000_000.0;
        double[] times = new double[repetitions];
        double sum = 0, start, end, duration;
        int vertexStart=0;
	...
	public static void timeD(String graphType, String sampleChosen, Graph graph, int repetitions, List<String> csvList) {
		final double CONVERTNS4MS = 1_000_000.0;
        double[] times = new double[repetitions];
        double sum = 0, start, end, duration;
        int vertexStart=0;
	...
	public static void timeFW(String graphType, String sampleChosen, Graph graph, int repetitions, List<String> csvList) {
		final double CONVERTNS4MS = 1_000_000.0;
        double[] times = new double[repetitions];
        double sum = 0, start, end, duration;
	...
	public static void timeFF(String graphType, String sampleChosen, Graph graph, int repetitions, List<String> csvList) {
		final double CONVERTNS4MS = 1_000_000.0;
        double[] times = new double[repetitions];
        double sum = 0, start, end, duration;
