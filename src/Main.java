    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (option) {
                ...
                case 6: // Caminho mínimo de origem única para todos os vértices (Bellman-Ford)
               ...
               case 7: // Caminho mínimo de origem única para todos os vértices (Dijkstra)
					System.out.println("\nDigrafo com Lista de Adjacências:");
                    System.out.println(digraphList);//toString
                    System.out.println("Digrafo com Matriz de Adjacências:");
                    System.out.println(digraphMatrix);//toString
                ...
                case 9: // Fluxo máximo em redes (Ford-Fulkerson)
                    System.out.println("\nDigrafo com Lista de Adjacências:");
                    System.out.println(digraphList);//toString
                    System.out.println("Digrafo com Matriz de Adjacências:");
                    System.out.println(digraphMatrix);//toString

                    System.out.println("Algoritmo: Fluxo máximo em redes (Ford-Fulkerson)");

                    System.out.println("\nDigrafo com Lista de Adjacências exe");
                    FordFulkerson ffList = new FordFulkerson(digraphList);
                    for(int i = 0; i < exe; i++) {
                        startTime = System.nanoTime();
                        ffList.maxFlow(0, 4);
                        endTime = System.nanoTime();
                    ...
                    System.out.println("Fluxo máximo: " + ffList.getMaxFlow());

                    System.out.println("\nDigrafo com Matriz de Adjacências exe");
                    FordFulkerson ffMatrix = new FordFulkerson(digraphMatrix);
                    for(int i = 0; i < exe; i++) {
                        startTime = System.nanoTime();
                        ffMatrix.maxFlow(0, 4);
                        endTime = System.nanoTime();
                        System.out.println("Tempo de execução: " + (endTime - startTime) + " ns");
                    }

                    System.out.println("Fluxo máximo: " + ffMatrix.getMaxFlow());
                    break;
